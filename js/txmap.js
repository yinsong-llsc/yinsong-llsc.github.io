...
$.ajax({
    ...
    data: {
        key: 'C2TBZ-JMACN-A2PFD-STHWK-G5TD3-NMF3N',
        output: 'jsonp',
    },
    dataType: 'jsonp',
...
function showWelcome() {
    ...
    let dist = getDistance(116.3530413, 27.9511188, ipLocation.result.location.lng, ipLocation.result.location.lat); //这里记得换成自己的经纬度
